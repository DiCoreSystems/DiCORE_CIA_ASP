...
public class WsdlParser {
    ...
    // Lists all operations. Allows duplicates.
    public String[] listOperations(String filename) throws SAXException, IOException,
    ...
    // Lists all operations. Does not allow duplicates.
    public String[] listOperationsUnique(String filename) throws SAXException, IOException,
            ParserConfigurationException {
